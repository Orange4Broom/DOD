...
export const MockUpData: MockDataTypes = [
    ...
    questions: [
      ...
      },
      {
        ...
        answers: [
          ...
          { id: "85", answer: "mackOS", correct: false },
  ...
  },
  {
    ...
    image: `${U211}`,
    description:
      "🧠 Zde si ověříte své schopnosti v krátkodobé i dlouhodobé paměti a zároveň se dozvíte, jak u nás probíhá výuka němčiny.",
    instructions:
    ...
    questions: [
      ...
      {
        questionText: "Jaký je správný překlad věty Ich liebe Deutsch?",
        type: "click",
        answers: [
          { id: "115", answer: "Já miluji Německo", correct: false },
          { id: "116", answer: "Já mám rád Němce", correct: false },
          { id: "117", answer: "Já mluvím německy", correct: false },
          { id: "118", answer: "Já miluji němčinu", correct: true },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    instructions:
      "📚 Výborně! Odsud se vydejte chodbou doprava až na konec. Učebnu S211 najdete přímo vedle sebe.",
    questions: [
      {
  ...
  },
  {
    ...
    image: `${U211}`,
    description:
      "📖 Zde se dozvíte zajímavosti o české i světové literatuře, zahrajete si stolní hry a zjistíte více o českém jazyce a literatuře na naší škole. ",
    instructions:
      "Skvěle! Vydejte se o patro víš, pak doleva a učebna SVT3 je přesně učebna na konci chodby.",
    questions: [
      {
        questionText: "Kdo napsal babičku?",
        type: "click",
        answers: [
          { id: "74", answer: "Alois Jirásek", correct: false },
          { id: "75", answer: "Božena Němcová", correct: true },
          { id: "76", answer: "Karel Hynek Mácha", correct: false },
          { id: "77", answer: "Jan Neruda", correct: false },
        ],
      },
      {
  ...
  },
  {
    ...
    description:
      "📖 Zde se dozvíte zajímavosti o české i světové literatuře, zahrajete si stolní hry a zjistíte více o českém jazyce a literatuře na naší škole. ",
    instructions:
      "Dobrá práce! Z této učebny se vydejte do leva. Na rohu konce chodby Vás čeká učebna, jejíž název nese S208.",
    questions: [
      {
        questionText: "Kdo napsal babičku?",
        type: "click",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        questionText: "Co je to úrok?",
        type: "click",
        answers: [
          { id: "82", answer: "Poplatek, který si účtuje banka za otevření účtu", correct: false },
          { id: "83", answer: "Příjem, který získáte za půjčení peněz", correct: true },
